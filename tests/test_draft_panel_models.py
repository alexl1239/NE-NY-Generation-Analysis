...
class DraftPanelModelTests(unittest.TestCase):
    ...
    def test_draft_page_is_separate_linked_and_plainly_labeled(self) -> None:
        ...
        self.assertIn("Panel regression results", page)
        self.assertIn("not causal effects", page)
        self.assertIn('id="draft-price-results-table"', page)
        self.assertIn('id="draft-reliability-results-table"', page)
        ...
        self.assertIn("renderSensitivityResults", javascript)
